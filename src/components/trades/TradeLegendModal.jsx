                ...
                <div className="space-y-4 mt-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg bg-emerald-50/50 border border-emerald-100">
                            <p className="font-semibold text-emerald-900 text-sm mb-1">Long Call</p>
                            <p className="text-xs text-emerald-700 mb-2 italic">Right to buy at strike</p>
                            <TradeTypeVisualization direction="bull" />
                        </div>
                        <div className="p-4 rounded-lg bg-emerald-50/50 border border-emerald-100">
                            <p className="font-semibold text-emerald-900 text-sm mb-1">Long Put</p>
                            <p className="text-xs text-emerald-700 mb-2 italic">Right to sell at strike</p>
                            <TradeTypeVisualization direction="bear" />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg bg-blue-50/50 border border-blue-100">
                            <p className="font-semibold text-blue-900 text-sm mb-1">Covered Call</p>
                            <p className="text-xs text-blue-700 mb-2 italic">Sell obligation (with stock)</p>
                            <TradeTypeVisualization direction="capped-bull" />
                        </div>
                        <div className="p-4 rounded-lg bg-blue-50/50 border border-blue-100">
                            <p className="font-semibold text-blue-900 text-sm mb-1">Cash Secured Put</p>
                            <p className="text-xs text-blue-700 mb-2 italic">Buy obligation (with cash)</p>
                            <TradeTypeVisualization direction="capped-profit" />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg bg-blue-50/50 border border-blue-100">
                            <p className="font-semibold text-blue-900 text-sm mb-1">Naked Call</p>
                            <p className="text-xs text-blue-700 mb-2 italic">Sell obligation (no stock)</p>
                            <TradeTypeVisualization direction="unlimited-loss" />
                        </div>
                        <div className="p-4 rounded-lg bg-blue-50/50 border border-blue-100">
                            <p className="font-semibold text-blue-900 text-sm mb-1">Naked Put</p>
                            <p className="text-xs text-blue-700 mb-2 italic">Buy obligation (no cash)</p>
                            <TradeTypeVisualization direction="bear" />
                        </div>
                    </div>
                </div>
