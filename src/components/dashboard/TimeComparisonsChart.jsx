            ...
            <div>
                ...
                <div className="px-0 md:p-4">
                    <ResponsiveContainer width="100%" height={280}>
                        <BarChart data={cumulativeData} margin={{ top: 5, right: 0, left: -10, bottom: 0 }} onClick={(e) => e?.activePayload && setSelectedPeriod(p => p === e.activePayload[0]?.payload?.date ? null : e.activePayload[0]?.payload?.date)} style={{ cursor: 'pointer' }}>
            ...
            <div>
                ...
                <div className="px-0 md:p-4">
                    <ResponsiveContainer width="100%" height={240}>
                        <BarChart data={tickerStackData} margin={{ top: 10, right: 0, left: -10, bottom: 0 }} onClick={(e) => e?.activePayload && setSelectedPeriod(p => p === e.activePayload[0]?.payload?.date ? null : e.activePayload[0]?.payload?.date)} style={{ cursor: 'pointer' }}>
