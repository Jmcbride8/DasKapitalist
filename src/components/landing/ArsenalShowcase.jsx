...
export default function ArsenalShowcase() {
    ...
    useEffect(() => {
        ...
        // Total scroll height = viewport height * number of extra cards
        ...
        const handleScroll = () => {
            ...
            // How far we've scrolled past the sticky anchor
            const scrolledIntoSection = -stickyTop;
            ...
            setActiveIndex(prev => {
                if (prev !== index) {
                    setExiting(true);
                    setTimeout(() => setExiting(false), 80);
                }
                return index;
            });
        };
    ...
    return (
        <section
            ...
            className="relative"
            style={{
                // Extra scroll space for each card after the first
                height: `calc(100vh + ${(items.length - 1) * 100}vh)`,
                background: '#000000',
            }}
        >
            {/* Sticky viewport */}
            <div className="sticky top-0 h-screen flex flex-col justify-center px-6 lg:px-20 overflow-hidden" style={{ background: '#000000' }}>
                {/* Header */}
                <div className="mb-10">
                ...
                {/* Card */}
                <div
                    className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center transition-opacity duration-150"
                    style={{ opacity: exiting ? 0 : 1 }}
                >
                    {/* Image side */}
                    <div className="relative rounded-2xl overflow-hidden border border-white/10" style={{ height: '340px' }}>
                        <AdminImage
